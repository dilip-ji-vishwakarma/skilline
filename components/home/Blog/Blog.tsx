...
export const Blog = () => {
  ...
  return (
    <div className="py-[60px] bg-[#F8F8F8]">
      <div className="container space-y-10">
        <Heading className="text-center">News and Updates</Heading>
        <div className="sm:grid xl:grid-cols-4 lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-5 items-start xl:space-y-0 lg:space-y-0 md:space-y-0 space-y-6">
